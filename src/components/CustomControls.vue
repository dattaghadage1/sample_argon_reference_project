<template>
  <section class="section pt-0">
    <!-- Checkboxes  Radios Toggle buttons Simple Slider Range Slider-->
    <div class="container">
      <!-- Custom controls -->
      <div class="row">
        ...
        <div class="col-lg-3 col-sm-6 mt-4 mt-md-0">
          ...
          ></base-switch>
          <br /><br />
          <base-switch v-model="switches.danger" type="danger"></base-switch>
          <base-switch
          ...
          ></base-switch>
          <br /><br />
          <base-switch v-model="switches.success" type="success"></base-switch>
          <base-switch
...
<script>
import BaseNav from "../Common/BaseNav";
