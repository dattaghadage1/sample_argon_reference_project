<template>
  <div class="section pb-0 section-components">
    <div class="container mb-5">
      ...
      <div class="row">
        <div class="col-lg-4 col-sm-6">
          <base-input placeholder="Regular" addonLeftIcon="ni ni-zoom-split-in"></base-input>
        </div>
        <div class="col-lg-4 col-sm-6">
    ...
    <div class="py-5 bg-secondary">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 col-sm-6">
            <base-input placeholder="Regular" alternative></base-input>
          </div>
          <div class="col-lg-4 col-sm-6">
        ...
        <div class="row">
          <div class="col-lg-4 col-sm-6">
            <base-input placeholder="Regular" addonLeftIcon="ni ni-zoom-split-in" alternative></base-input>
          </div>
          <div class="col-lg-4 col-sm-6">
