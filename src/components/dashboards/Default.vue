<template>
  <div class="py-4 container-fluid">
    <div class="row">
      <div class="col-lg-12">
        <p>it is independent mini statistics cards diff. behave based on props[KPI]</p>
        <div class="row">
          <div class="col-lg-3 col-md-6 col-12">
            <!-- it is independent mini statistics cards diff. behave based on props[KPI] -->
        ...
        <div class="row">
          <div class="col-lg-7 mb-lg">
            <!-- independant chart component pass props -->
            <p>chart component</p>
      ...
      <span class='font-weight-bold'>4% more</span> in 2021" :chart="{
        ...
        datasets: [
          ...
          <div class="col-lg-5">
            <!-- independent carousel component pass props -->
        ...
        <div class="row mt-4">
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <!-- independant team-member card & passed props  -->
            <p>team-member card</p>
            <member-card :members="[
              {
                img: team1,
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <!-- independant todo list component -->
          ...
          <div class="col-lg-4">
            <p>independant  progress-track-card</p>
            <!-- <p>independant  progress-track-card</p> -->
            <progress-track-card title="Progress track" :list="[
              {
        ...
        <div class="row mt-4">
          <div class="col-12 col-lg-5">
            <!-- independant post-card -->
            <post-card />
          </div>
          <div class="col-12 col-lg-7">
            <p>project card</p>
            <!-- <p>project card</p> -->
            <project-card :headers="['Project', 'Budget', 'Status', 'Completion', '']" :items="[
              {
